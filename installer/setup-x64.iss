; Inno Setup 6 Script for Mistral AI Office Add-in (64-bit / x64)
; Target: 64-bit Microsoft Office (Word, Excel, PowerPoint, Outlook)

#define MyAppName "Mistral AI Office Add-in (64-bit)"
...
DefaultDirName={pf64}\MistralOfficeAddin
DisableProgramGroupPage=yes
LicenseFile=..\LICENSE
OutputBaseFilename=MistralOfficeAddin-Setup-x64
...
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\MistralOfficeAddin.dll"""; StatusMsg: "Registering 64-bit COM components..."; Flags: runhidden

[UninstallRun]
; Unregister COM Server
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/unregister ""{app}\MistralOfficeAddin.dll"""; StatusMsg: "Unregistering COM components..."; Flags: runhidden
