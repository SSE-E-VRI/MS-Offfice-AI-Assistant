...
| ~~D-5~~ | — | **RESOLVED.** Action-type allow-lists unified and sourced dynamically from `ToolRegistry.FormatActionTypesList(host)` in `PromptAssembler.cs` (Phase C2), preserving hand-tuned few-shot examples and Golden Master baseline. |
